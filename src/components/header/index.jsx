...
import siteLogo from "../../assets/images/bookstore-logo.jpg";
            ...
            <div className="header-wrapper">
              <div className="logo-wrapper">
                <Link to="/" className="site-logo" title="logo">
                  ...
                  <p class="golden-text">AFRICAN COLLECTION</p>
                </Link>
              </div>
              <div className="nav-wrapper">
                <div className="top-right-bar">
                  ...
                  <List className="cart-country-wrap">
                    <ListItem className="cart-link, golden-text"
                    >
                      <Link to="/cart" title="Cart" className="golden-text">
                  ...
                  {authContext.user.id && (
                    <List className="right">
                      <Button className="golden-text" onClick={() => logOut()} variant="outlined">
                      LOGOUT
                      </Button>
                    </List>
                  )}
